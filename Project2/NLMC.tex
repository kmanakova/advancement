...
Numerically, we observe a travelling wave solution to the reduced system described by equations~\ref{eq::a_ODE}, and~\ref{eq::yM_eq} and is shown in Fig.~\ref{fig::A_wave}.
\begin{figure}[h]
\centering
...
\end{align}
We define a Non-local Maxwell Condition Number by the RHS of the above equation. The reason will become clear in what follows. In our specific case,
\begin{align}
